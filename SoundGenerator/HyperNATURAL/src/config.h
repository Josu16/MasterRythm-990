...
#define QUEUE_SIZE_MSECS 40		// size of the sound queue in milliseconds duration (ajustado para 5 chunks)
#define CHUNK_SIZE	256	// number of samples, written to sound device at once
